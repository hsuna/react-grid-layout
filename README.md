...
[![travis build](https://travis-ci.org/hsuna/react-grid-layout.svg?branch=master)](https://travis-ci.org/hsuna/react-grid-layout)
...
// See `handle` as used in https://github.com/hsuna/react-resizable#resize-handle
